...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            // ===== VALIDATIONS =====
            if (name.isEmpty() || fname.isEmpty() || address.isEmpty() || phone.isEmpty() || email.isEmpty() || aadhar.isEmpty()) {
            ...
            try {
                double xPercent = Double.parseDouble(x);
                double xiiPercent = Double.parseDouble(xii);
                if (xPercent < 0 || xPercent > 100 || xiiPercent < 0 || xiiPercent > 100) {
                    JOptionPane.showMessageDialog(null, "Percentages must be between 0 and 100!");
                    return;
                }
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "Please enter valid numbers for percentages!");
                return;
            }
